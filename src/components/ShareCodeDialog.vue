<template>
  <dialog :open="open" class="share-code-dialog" role="dialog" aria-modal="true" aria-labelledby="share-code-title">
    <article class="card" v-if="open">
      <header>
        <h2 id="share-code-title" style="font-size: 1rem; font-weight: bold; margin: 0;">生成分享码</h2>
      </header>

      <div class="dialog-body">
        <p style="margin: 0 0 0.75rem 0; color: var(--muted, #666666); font-size: 0.9rem;">
